                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="student_roll_number" id="student_roll_number"
                                    class="form-control" />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Xoá</button>
            </div>
            ...
            success: function(data) {
                ...
                if (data.error) {
                    ...
                    if (data.error_student_roll_number != '') {
                        $('#error_student_roll_number').text(data
