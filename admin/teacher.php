        ...
        <form method="post" id="teacher_form" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">Địa chỉ email <span class="text-danger">*</span></label>
                            <div class="col-md-8">
...
<div class="modal" id="viewModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Chi tiết giảng viên</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
...
<div class="modal" id="deleteModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <h3 align="center">Bạn có chắc muốn xóa mục này không?</h3>
            </div>
            ...
            success: function(data) {
                ...
                if (data.error) {
                    ...
                    if (data.error_teacher_qualification != '') {
                        $('#error_teacher_qualification').text(data
    ...
    $(document).on('click', '.edit_teacher', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#error_teacher_image').html('<img src="teacher_image/' + data
                    .teacher_image + '" class="img-thumbnail" width="50" />');
