...
<div class="container" style="margin-top:30px">
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-9">Tình trạng tham dự lớp học</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <select name="report_action" id="report_action" class="form-control">
                        ...
                        <option value="chart_report">Biểu đồ</option>
                    </select>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="button" name="create_report" id="create_report" class="btn btn-success btn-sm">Tạo
                    Report</button>
    ...
    $('#create_report').click(function() {
        ...
        if (error == 0) {
            ...
            if (action == 'chart_report') {
                location.href = "chart.php?action=student_chart&student_id=" + student_id +
                    "&from_date=" + from_date + "&to_date=" + to_date;
            }
        }
